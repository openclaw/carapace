  ...
  test(
    ...
    async () => {
      ...
      try {
        ...
        // Guards order-of-magnitude entry bloat while leaving bounded room for
        // shared interactive-preview behavior such as Toast lifecycle control.
        expect(entryStats.size).toBeLessThan(170_000);
