...
const contents = {
  ...
  "interface-primitives": () =>
    `${pageIntro("Interface", "Shared primitives", "Framework-neutral classes exported through stable and candidate package entry points. Consumers keep their own content and behavior.")}
    <div class="scope-note"><strong>Canonical scope</strong><p>Stable foundations come from components.css; Badge and the other opt-in feedback patterns come from candidate/feedback.css. Preview-only examples are not promoted into either contract.</p></div>
    <section aria-labelledby="primitive-index"><div class="section-heading"><div><p class="eyebrow">Index</p><h2 id="primitive-index">Primitive families</h2></div><span class="oc-pill">50 references</span></div>
      <div class="reference-card-grid primitive-index-grid">
        ...
        <a class="reference-card" href="./button/"><span>.oc-button</span><strong>Button</strong><p>Lab-only native button study aligned with stable Action.</p></a>
  ...
  "effect-interaction": () =>
    ...
    <section data-section-kind="markup" aria-labelledby="effect-interaction-markup"><div class="section-heading"><div><p class="eyebrow">Contract</p><h2 id="effect-interaction-markup">Animate the changed property</h2></div></div>${codeBlock(`<button class="oc-avatar-button" type="button" aria-label="Open agent profile">\n  <span class="oc-avatar">…</span>\n</button>`, "html")}</section>
...
<span class="oc-avatar oc-avatar-pixel" data-animated="true" role="img" aria-label="Shelly">…</span>`, "html")}</section>
  ...
  "primitive-badge": () =>
    ...
    <section data-section-kind="preview" aria-labelledby="badge-plain-preview"><div class="section-heading"><div><p class="eyebrow">Preview</p><h2 id="badge-plain-preview">Plain identity markers</h2></div><span class="oc-pill">.oc-badge-plain</span></div>
      <div class="specimen-frame"><div class="primitive-variant-list primitive-badge-list"><span class="oc-badge oc-badge-error oc-badge-plain">production</span><span class="oc-badge oc-badge-info oc-badge-plain">development</span><span class="oc-badge oc-badge-warning oc-badge-plain">staging</span><span class="oc-badge oc-badge-neutral oc-badge-plain">viewer</span></div></div>
    </section>
  ...
  "primitive-button": () =>
    `${pageIntro("Lab component", "Button", "A Lab-only button study kept behaviorally aligned with the stable Action contract without creating a second exported primitive.")}
    <section data-section-kind="preview" aria-labelledby="button-preview"><div class="section-heading"><div><p class="eyebrow">Preview</p><h2 id="button-preview">Native button states</h2></div><span class="oc-pill">.oc-button</span></div>
      <div class="specimen-frame"><div class="primitive-variant-list primitive-button-list"><button class="oc-button oc-button-primary" type="button">Save changes</button><button class="oc-button oc-button-secondary" type="button">Preview</button><button class="oc-button oc-button-ghost" type="button">Cancel</button><button class="oc-button oc-button-secondary oc-button-icon" type="button" aria-label="Add item">+</button><button class="oc-button oc-button-secondary" type="button" disabled>Unavailable</button></div></div>
    </section>
    ...
    <section data-section-kind="guidance" aria-labelledby="button-guidance"><div class="section-heading"><div><p class="eyebrow">Guidance</p><h2 id="button-guidance">Study here, ship Action</h2></div></div>${guidanceList(["Use the stable .oc-action contract in consumer code.", "Use a native button for in-place actions and links for navigation.", "Name every icon-only button and apply an explicit visual variant.", "Disabled styling uses reduced opacity and a not-allowed cursor; disable only when the reason is visible or immediately inferable."])}</section>`,
  ...
  "primitive-action": () =>
    ...
    <section data-section-kind="guidance" aria-labelledby="action-states"><div class="section-heading"><div><p class="eyebrow">States</p><h2 id="action-states">Responsive interaction feedback</h2></div></div>${guidanceList(["Primary, secondary, and ghost variants cover visual hierarchy.", "Hover, focus-visible, active, and disabled visual states are exported.", "Disabled styling is exported; consumers still own availability rules and loading behavior.", "Icon-only actions require a consumer-provided accessible name."])}</section>`,
  ...
  "primitive-checkbox": () =>
    ...
    <section data-section-kind="preview" aria-labelledby="checkbox-preview"><div class="section-heading"><div><p class="eyebrow">Preview</p><h2 id="checkbox-preview">Selection states</h2></div><span class="oc-pill">.oc-checkbox</span></div>
      <div class="specimen-frame oc-app-surface"><div class="primitive-checkbox-stack"><label class="oc-check"><input class="oc-checkbox" type="checkbox" name="verified" value="true" checked /><span>Include verified publishers</span></label><label class="oc-check"><input class="oc-checkbox" type="checkbox" name="prerelease" value="true" /><span>Show prerelease packages</span></label><label class="oc-check"><input class="oc-checkbox" type="checkbox" name="selectAll" value="true" data-preview-indeterminate /><span>Select all components</span></label><label class="oc-check"><input class="oc-checkbox" type="checkbox" name="managed" value="true" disabled /><span>Managed by organization</span></label><div class="oc-field"><label class="oc-check"><input class="oc-checkbox" type="checkbox" name="notifications" value="true" aria-invalid="true" aria-describedby="checkbox-notifications-error" /><span>Send release notifications</span></label><span class="oc-field-message" id="checkbox-notifications-error">Choose whether releases should notify maintainers.</span></div></div></div>
    </section>
  ...
  "primitive-radio": () =>
    ...
    <section data-section-kind="preview" aria-labelledby="radio-preview"><div class="section-heading"><div><p class="eyebrow">Preview</p><h2 id="radio-preview">Single selection</h2></div><span class="oc-pill">.oc-radio</span></div>
      <div class="specimen-frame oc-app-surface"><div class="primitive-checkbox-stack"><fieldset class="oc-radio-group"><legend>Default visibility</legend><label class="oc-radio-option"><input class="oc-radio" type="radio" name="visibility-preview" value="public" checked /><span>Public</span></label><label class="oc-radio-option"><input class="oc-radio" type="radio" name="visibility-preview" value="private" /><span>Private</span></label><label class="oc-radio-option"><input class="oc-radio" type="radio" name="visibility-preview" value="organization" disabled /><span>Organization only</span></label></fieldset><div class="oc-field"><fieldset class="oc-radio-group" aria-invalid="true" aria-describedby="radio-delivery-error"><legend>Release delivery</legend><label class="oc-radio-option"><input class="oc-radio" type="radio" name="delivery-preview" value="stable" /><span>Stable only</span></label><label class="oc-radio-option"><input class="oc-radio" type="radio" name="delivery-preview" value="all" /><span>All releases</span></label></fieldset><span class="oc-field-message" id="radio-delivery-error">Choose one release channel.</span></div></div></div>
    </section>
    ...
    <section data-section-kind="preview" aria-labelledby="option-card-preview"><div class="section-heading"><div><p class="eyebrow">Preview</p><h2 id="option-card-preview">Choice and connect</h2></div><span class="oc-pill">.oc-option-card</span></div>
      <div class="specimen-frame"><div style="display: grid; gap: var(--oc-space-5); width: min(100%, 42rem); grid-template-columns: repeat(auto-fit, minmax(18rem, 1fr)); align-items: start;">
        <fieldset class="oc-option-group" style="border: 0; margin: 0; padding: 0;">
          ...
          <label class="oc-option-card"><input type="radio" name="setup-path" disabled /><span class="oc-option-card-icon"><i data-lucide="download" aria-hidden="true"></i></span><span class="oc-option-card-copy"><strong>Import</strong><small>Bring settings from another install.</small></span></label>
        </fieldset>
...
`,
  ...
  <table class="oc-table">
    ...
    <section data-section-kind="guidance" aria-labelledby="table-guidance"><div class="section-heading"><div><p class="eyebrow">Guidance</p><h2 id="table-guidance">Use tables for comparison</h2></div></div>${guidanceList(["The anatomy is renderer-agnostic: TanStack Table, AG Grid, or plain markup consume the same classes while owning sorting, filtering, and virtualization logic.", "Use a table only when rows share comparable columns.", "Provide a caption and keep native table, header, and scope semantics.", "Name and focus the scroll region when the table can overflow.", "The bounded sticky-header state remains a workbench Lab study and is not part of the Candidate export.", "Use .oc-table-interactive only when each row actually responds to interaction.", "Move row actions into a clearly labeled final column."])}</section>`,
...
<code class="oc-text oc-text-mono">--oc-text-primary</code>`,
  ...
  "chart-sparkline": () =>
    `${pageIntro("Charts", "Sparkline & Delta", "Micro-trend and period-over-period change beside a metric. The consumer computes the series; the components own size, stroke, and tone.")}
    <section data-section-kind="preview" aria-labelledby="sparkline-preview"><div class="section-heading"><div><p class="eyebrow">Preview</p><h2 id="sparkline-preview">Metric with trend and change</h2></div><span class="oc-pill">.oc-sparkline</span></div>
      <div class="specimen-frame oc-app-surface"><div class="oc-summary-strip" style="max-width:44rem">
        <div class="oc-summary-metric"><span class="oc-summary-metric-copy"><small>GitHub events</small><strong>710</strong><small><span class="oc-delta" data-direction="up"><span class="oc-delta-arrow" aria-hidden="true">&#9650;</span>+12% vs prev day</span></small></span><svg class="oc-sparkline" viewBox="0 0 120 28" preserveAspectRatio="none" role="img" aria-label="GitHub events, last 14 periods"><path class="oc-sparkline-line" d="M0 22 H8 V18 H17 V20 H25 V12 H34 V15 H42 V9 H51 V14 H59 V6 H68 V10 H76 V8 H85 V13 H93 V5 H102 V9 H110 V4 H120"/><rect class="oc-sparkline-endpoint" x="117" y="2" width="3" height="4"/></svg></div>
        <div class="oc-summary-metric"><span class="oc-summary-metric-copy"><small>Discord messages</small><strong>91</strong><small><span class="oc-delta" data-direction="down"><span class="oc-delta-arrow" aria-hidden="true">&#9660;</span>-8% vs prev day</span></small></span><svg class="oc-sparkline" data-tone="accent" viewBox="0 0 120 28" preserveAspectRatio="none" role="img" aria-label="Discord messages, last 14 periods"><path class="oc-sparkline-line" d="M0 8 H8 V14 H17 V10 H25 V18 H34 V13 H42 V19 H51 V15 H59 V22 H68 V16 H76 V20 H85 V17 H93 V23 H102 V19 H110 V21 H120"/></svg></div>
        <div class="oc-summary-metric"><span class="oc-summary-metric-copy"><small>Needs release</small><strong>31</strong><small><span class="oc-delta" data-tone="negative"><span class="oc-delta-arrow" aria-hidden="true">&#9650;</span>+4 vs last week</span></small></span></div>
      </div><div style="margin-top:var(--oc-space-5)"><div class="oc-chart-hover" data-oc-hover="[[&quot;2026-07-16&quot;,610],[&quot;2026-07-17&quot;,580],[&quot;2026-07-18&quot;,640],[&quot;2026-07-19&quot;,720],[&quot;2026-07-20&quot;,1450],[&quot;2026-07-21&quot;,900],[&quot;2026-07-22&quot;,760],[&quot;2026-07-23&quot;,820],[&quot;2026-07-24&quot;,780],[&quot;2026-07-25&quot;,880],[&quot;2026-07-26&quot;,940],[&quot;2026-07-27&quot;,801]]" data-oc-hover-unit="events"><svg class="oc-sparkline" data-size="lg" viewBox="0 0 600 48" preserveAspectRatio="none" role="img" aria-label="Combined activity, last 12 days"><path class="oc-sparkline-line" d="M0 43.6 H50 V45.0 H100 V42.1 H150 V38.2 H200 V3.0 H250 V29.6 H300 V36.3 H350 V33.4 H400 V35.3 H450 V30.5 H500 V27.6 H550 V34.3 H600"/><rect class="oc-sparkline-endpoint" x="597" y="32.3" width="3" height="4"/></svg></div></div></div>
    </section>
    <section data-section-kind="markup" aria-labelledby="sparkline-markup"><div class="section-heading"><div><p class="eyebrow">Markup</p><h2 id="sparkline-markup">Precomputed path, stepped segments</h2></div></div>${codeBlock(`<svg class="oc-sparkline" viewBox="0 0 120 28"\n  preserveAspectRatio="none" role="img" aria-label="GitHub events, last 28 days">\n  <path class="oc-sparkline-line" d="M0 22 H8 V18 H17 &#8230; H120" />\n  <rect class="oc-sparkline-endpoint" x="117" y="2" width="3" height="4" />\n</svg>\n\n<span class="oc-delta">\n  <span class="oc-delta-arrow" aria-hidden="true">&#9650;</span>+12% vs prev day\n</span>`, "html")}</section>
    <section data-section-kind="guidance" aria-labelledby="sparkline-guidance"><div class="section-heading"><div><p class="eyebrow">Guidance</p><h2 id="sparkline-guidance">Direction is not a value judgment</h2></div></div>${guidanceList(["Keep delta text neutral by default: a quiet week after a release is healthy, and a maintainer on leave is not a regression. data-direction tints only the arrow as a scannable cue; data-tone paints the whole delta and is reserved for metrics with a genuinely good or bad direction, such as repos needing release.", "Generate stepped paths (H/V segments) at build time; no runtime charting library, and the number must stay readable if the SVG does not render.", "Give every sparkline an aria-label naming the metric and window; the path alone is decoration.", "One series per sparkline. If two series need comparing, use a chart with axes.", "Hover readouts are optional but ship in the box: wrap the chart in .oc-chart-hover with data-oc-hover=[[label, value], ...] and call initChartHover() from @openclaw/carapace/charts.js."])}</section>`,

  "chart-bars": () =>
    `${pageIntro("Charts", "Bars & Split", "Discrete periods and part-of-whole share beside a metric. Same contract as the sparkline: the consumer precomputes geometry, the components own size and color.")}
    <section data-section-kind="preview" aria-labelledby="bars-preview"><div class="section-heading"><div><p class="eyebrow">Preview</p><h2 id="bars-preview">Columns for discrete periods</h2></div><span class="oc-pill">.oc-bars</span></div>
      <div class="specimen-frame oc-app-surface"><div class="oc-summary-strip" style="max-width:44rem">
        <div class="oc-summary-metric"><span class="oc-summary-metric-copy"><small>PRs merged</small><strong>400</strong><small><span class="oc-delta" data-direction="up"><span class="oc-delta-arrow" aria-hidden="true">&#9650;</span>+9% vs prev day</span></small><svg class="oc-bars" viewBox="0 0 120 28" preserveAspectRatio="none" role="img" aria-label="PRs merged, last 12 days"><rect class="oc-bars-bar" x="1" y="19.3" width="8" height="8.7"/><rect class="oc-bars-bar" x="11" y="15" width="8" height="13"/><rect class="oc-bars-bar" x="21" y="17.2" width="8" height="10.8"/><rect class="oc-bars-bar" x="31" y="10.7" width="8" height="17.3"/><rect class="oc-bars-bar" x="41" y="12.8" width="8" height="15.2"/><rect class="oc-bars-bar" x="51" y="8.5" width="8" height="19.5"/><rect class="oc-bars-bar" x="61" y="15" width="8" height="13"/><rect class="oc-bars-bar" x="71" y="6.300000000000001" width="8" height="21.7"/><rect class="oc-bars-bar" x="81" y="10.7" width="8" height="17.3"/><rect class="oc-bars-bar" x="91" y="4.199999999999999" width="8" height="23.8"/><rect class="oc-bars-bar" x="101" y="8.5" width="8" height="19.5"/><rect class="oc-bars-bar oc-bars-current" x="111" y="2" width="8" height="26"/></svg></span></div>
        <div class="oc-summary-metric"><span class="oc-summary-metric-copy"><small>Signal mix</small><strong>2,644</strong><svg class="oc-split" viewBox="0 0 100 8" preserveAspectRatio="none" role="img" aria-label="Signal mix: GitHub 86 percent, Discord 11 percent, other 3 percent"><rect class="oc-split-segment" x="0" y="0" width="86" height="8"/><rect class="oc-split-segment oc-split-secondary" x="86" y="0" width="11" height="8"/><rect class="oc-split-segment oc-split-muted" x="97" y="0" width="3" height="8"/></svg><ul class="oc-split-legend"><li><span class="oc-split-key" aria-hidden="true"></span>GitHub</li><li><span class="oc-split-key oc-split-secondary" aria-hidden="true"></span>Discord</li><li><span class="oc-split-key oc-split-muted" aria-hidden="true"></span>Other</li></ul></span></div>
      </div></div></section>
    <section data-section-kind="markup" aria-labelledby="bars-markup"><div class="section-heading"><div><p class="eyebrow">Markup</p><h2 id="bars-markup">Precomputed rects, role-colored segments</h2></div></div>${codeBlock(
      `<svg class="oc-bars" viewBox="0 0 120 28"\n  preserveAspectRatio="none" role="img" aria-label="PRs merged, last 12 days">\n  <rect class="oc-bars-bar" x="1" y="19.3" width="8" height="8.7" />\n  &#8230;\n  <rect class="oc-bars-bar oc-bars-current" x="111" y="2" width="8" height="26" />\n</svg>\n\n<svg class="oc-split" viewBox="0 0 100 8"\n  preserveAspectRatio="none" role="img" aria-label="Signal mix: GitHub 86%, Discord 11%, other 3%">\n  <rect class="oc-split-segment" x="0" y="0" width="86" height="8" />\n  <rect class="oc-split-segment oc-split-secondary" x="86" y="0" width="11" height="8" />\n  <rect class="oc-split-segment oc-split-muted" x="97" y="0" width="3" height="8" />\n</svg>`,
      "html",
    )}</section>
    <section data-section-kind="guidance" aria-labelledby="bars-guidance"><div class="section-heading"><div><p class="eyebrow">Guidance</p><h2 id="bars-guidance">Columns count, splits compare</h2></div></div>${guidanceList(["Use oc-bars when periods are discrete counts a reader might compare individually; use oc-sparkline when only the shape of the trend matters.", "Only the newest column carries oc-bars-current; a bar chart full of accent reads as decoration, not data.", "Split segments must sum to the viewBox width and follow the chart color roles: accents for neutral series, status colors only for genuine meaning.", "Always pair a split with its legend or labeled caption; proportion without names is unreadable.", "Precompute all geometry at build time and keep the metric number readable if the SVG does not render."])}</section>`,
  ...
  "interface-examples": () =>
    ...
    <div class="scope-note"><strong>Ownership boundary</strong><p>These controls demonstrate states and density. Their behavior and markup remain consumer-owned. Status labels intentionally use the canonical candidate Badge anatomy, including its border and state dot, instead of a preview-local pill.</p></div>
  ...
  "composition-product": () =>
    ...
    <section aria-labelledby="product-specimen"><div class="section-heading"><div><p class="eyebrow">Specimen</p><h2 id="product-specimen">Package directory</h2></div><button class="button button-secondary button-small" type="button">Export</button></div>
      ...
      <div class="table-wrap"><table><thead><tr><th scope="col">Package</th><th scope="col">Publisher</th><th scope="col">Status</th><th scope="col">Updated</th></tr></thead><tbody><tr><td><strong>design-audit</strong><small>UI compliance checks</small></td><td>openclaw</td><td><span class="oc-badge oc-badge-success">Verified</span></td><td>2m ago</td></tr><tr><td><strong>convex</strong><small>Backend workflow router</small></td><td>openclaw</td><td><span class="oc-badge oc-badge-info">Official</span></td><td>1h ago</td></tr><tr><td><strong>release-notes</strong><small>Draft release summaries</small></td><td>community</td><td><span class="oc-badge oc-badge-warning">Review</span></td><td>Yesterday</td></tr></tbody></table></div>
    </section>
  ...
  "resource-package-exports": () =>
    ...
    <section aria-labelledby="package-entry-points"><div class="section-heading"><div><p class="eyebrow">Entry points</p><h2 id="package-entry-points">Import only what the consumer needs</h2></div></div>${referenceTable(
      ...
      [
        ...
        ["./candidate/embed.css", "Opt-in MCP app embed token contract and branding slot."],
        ...
        ["./charts.js", "Optional hover readout module for chart primitives; CSS stays fully usable without it."],
