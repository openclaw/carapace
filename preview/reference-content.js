...
<code class="oc-text oc-text-mono">--oc-text-primary</code>`,
  ...
  "chart-sparkline": () =>
    ...
    <section data-section-kind="markup" aria-labelledby="sparkline-markup"><div class="section-heading"><div><p class="eyebrow">Markup</p><h2 id="sparkline-markup">Precomputed path, stepped segments</h2></div></div>${codeBlock(`<svg class="oc-sparkline" viewBox="0 0 120 28"\n  preserveAspectRatio="none" role="img" aria-label="GitHub events, last 28 days">\n  <path class="oc-sparkline-line" d="M0 22 H8 V18 H17 &#8230; H120" />\n  <rect class="oc-sparkline-endpoint" x="117" y="2" width="3" height="4" />\n</svg>\n\n<span class="oc-delta">\n  <span class="oc-delta-arrow" aria-hidden="true">&#9650;</span>+12% vs previous day\n</span>`, "html")}</section>
    <section data-section-kind="guidance" aria-labelledby="sparkline-guidance"><div class="section-heading"><div><p class="eyebrow">Guidance</p><h2 id="sparkline-guidance">Direction is not a value judgment</h2></div></div>${guidanceList(["Keep deltas neutral by default: a quiet week after a release is healthy, and a maintainer on leave is not a regression. Use data-tone only for metrics with a genuinely good or bad direction, such as repos needing release.", "Generate stepped paths (H/V segments) at build time; no runtime charting library, and the number must stay readable if the SVG does not render.", "Give every sparkline an aria-label naming the metric and window; the path alone is decoration.", "One series per sparkline. If two series need comparing, use a chart with axes."])}</section>`,
