...
const contents = {
  ...
  "resource-package-exports": () =>
    ...
    <section aria-labelledby="package-order"><div class="section-heading"><div><p class="eyebrow">Order</p><h2 id="package-order">Foundations precede adapters</h2></div></div>${codeBlock(`@import "@openclaw/design-system/tokens.css";\n@import "@openclaw/design-system/themes.css";\n@import "@openclaw/design-system/typography.css";\n@import "@openclaw/design-system/components.css";\n@import "@openclaw/design-system/themes/product.css";\n@import "@openclaw/design-system/compat/clawhub.css";\n@import "@openclaw/design-system/tailwind.css";`)}</section>`,
  ...
  "resource-design-audit": () =>
    `${pageIntro("Resources", "Design audit", "Audit design-system drift with deterministic source checks, rendered evidence, stable rule IDs, and explicit fix boundaries.")}
