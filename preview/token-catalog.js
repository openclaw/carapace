export const tokenGroups = [
  ...
  { id: "background", label: "Background", sample: "color" },
  { id: "accent", label: "Accent", sample: "color" },
  { id: "text", label: "Text", sample: "text" },
  { id: "border", label: "Border", sample: "border" },
  { id: "surface", label: "Surface", sample: "color" },
  { id: "feedback", label: "Interface feedback", sample: "feedback" },
  { id: "status", label: "Status", sample: "status" },
  { id: "input", label: "Input", sample: "input" },
  { id: "diff", label: "Diff", sample: "diff" },
