export const tokenGroups = [
  ...
  },
  {
    ...
    sample: "color",
    comparison: true,
    description: "Theme-aware page, surface, recessed, elevated, and contrast backgrounds.",
  },
  {
    id: "accent",
    label: "Accent",
  ...
  },
  {
    ...
    sample: "text",
    comparison: true,
    description: "Primary, supporting, inactive, inverse, link, and on-accent text hierarchy.",
  },
  {
    id: "border",
    label: "Border",
    sample: "border",
    comparison: true,
    description: "Subtle, strong, and accent emphasis for boundaries.",
  },
  {
    id: "surface",
    label: "Surface",
    sample: "color",
    comparison: true,
    description: "Cards, overlays, shared control states, and soft accent surfaces.",
  },
  {
    id: "feedback",
...
export const tokenDefinitions = [
  ...
  { variable: "--oc-bg-recessed", group: "background" },
  { variable: "--oc-bg-contrast", group: "background" },
  ...
  { variable: "--oc-text-inactive", group: "text" },
  { variable: "--oc-text-inverse", group: "text" },
  { variable: "--oc-text-link", group: "text" },
  { variable: "--oc-text-on-accent", group: "text" },
  { variable: "--oc-border-subtle", group: "border" },
  { variable: "--oc-border-strong", group: "border" },
  ...
  { variable: "--oc-control-bg-hover", group: "surface" },
